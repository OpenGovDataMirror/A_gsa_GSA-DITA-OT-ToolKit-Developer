...
<xsl:stylesheet e:version="2.5"
	...
	<xsl:import href="plugin:GSA_pdf:cfg/fo/attrs/commons-attr.xsl" />
	<xsl:import href="plugin:org.dita.pdf2:xsl/fo/commons.xsl" />
	<xsl:import href="plugin:GSA_pdf:xsl/fo/commons.xsl" />
	<xsl:import href="plugin:org.dita.pdf2:cfg/fo/attrs/toc-attr.xsl" />
	<xsl:import href="plugin:GSA_pdf:cfg/fo/attrs/toc-attr.xsl" />
	<xsl:import href="plugin:org.dita.pdf2:xsl/fo/toc.xsl" />
	<xsl:import href="plugin:GSA_pdf:xsl/fo/toc.xsl" />
	...
	<xsl:import href="plugin:GSA_pdf:cfg/fo/attrs/front-matter-attr.xsl" />
	<xsl:import href="plugin:org.dita.pdf2:xsl/fo/front-matter.xsl" />
	<xsl:import href="plugin:GSA_pdf:xsl/fo/front-matter.xsl" />
	...
	<xsl:import href="plugin:GSA_pdf:cfg/fo/attrs/pr-domain-attr.xsl" />
	<xsl:import href="plugin:org.dita.pdf2:xsl/fo/pr-domain.xsl" />
	<xsl:import href="plugin:GSA_pdf:xsl/fo/pr-domain.xsl" />
	...
	<xsl:import href="plugin:GSA_pdf:cfg/fo/attrs/static-content-attr.xsl" />
	<xsl:import href="plugin:org.dita.pdf2:xsl/fo/static-content.xsl" />
	<xsl:import href="plugin:GSA_pdf:xsl/fo/static-content.xsl" />
